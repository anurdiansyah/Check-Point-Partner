...
namespace CheckPointPartner.WebUI.Data
{
    public class UsersContext : IdentityDbContext
    {
        ...
        public virtual DbSet<UserDetailWithPartner> UserDetailWithPartners { get; set; }
        public virtual DbSet<CheckInReport> CheckInReports { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => new { e.UserDetailId });

                entity.Property(e => e.UserDetailId).IsRequired();
            });

            modelBuilder.Entity<UserDetailWithPartner>(entity =>
            {
                entity.HasKey(e => new { e.UserDetailId });
            ...
            {
                entity.HasKey(e => new { e.PartnerId });
            ...
            {
                entity.HasKey(e => new { e.RowNumber });
            });
        }
